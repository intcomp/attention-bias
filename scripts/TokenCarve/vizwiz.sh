...
python -m TokenCarve.TokenCarve.TokenCarve_model_vqa_loader \
    ...
    --answers-file ./playground/data/eval/vizwiz/answers/${CKPT}/TokenCarve/r_${rank_list}/k_${Ks}_${TAG}.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
...
python scripts/convert_vizwiz_for_submission.py \
    ...
    --result-file ./playground/data/eval/vizwiz/answers/${CKPT}/TokenCarve/r_${rank_list}/k_${Ks}_${TAG}.jsonl \
    --result-upload-file ./playground/data/eval/vizwiz/answers_upload/${CKPT}/TokenCarve/r_${rank_list}/k_${Ks}_${TAG}.json

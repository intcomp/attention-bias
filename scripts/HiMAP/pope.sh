...
python -m HiMAP.src.HiMAP.inference.model_vqa_loader \
    ...
    --answers-file ./playground/data/eval/pope/answers/${CKPT}/HiMAP/rank${TXT_RATIO}/Ks${TXT_LAYER}/result_${TAG}.jsonl \
    --temperature 0 \
    --use-hmap-v \
    --sys-length 35 \
    --img-length 576 \
...
python src/LLaVA/llava/eval/eval_pope.py \
    --annotation-dir ./playground/data/eval/pope/coco \
    --question-file ./playground/data/eval/pope/llava_pope_test.jsonl \
    --result-file ./playground/data/eval/pope/answers/${CKPT}/HiMAP/rank${TXT_RATIO}/Ks${TXT_LAYER}/result_${TAG}.jsonl
